...
CRGBSet CJLeg_A(leds(0,29)) ;
CRGBSet CJLeg_B(leds(NUM_LEDS_PER_STRIP, NUM_LEDS_PER_STRIP + 29)) ;
CRGBSet CJLeg_C(leds(2 * NUM_LEDS_PER_STRIP, 2 *  NUM_LEDS_PER_STRIP + 29)) ;
CRGBSet CJLeg_D(leds(3 * NUM_LEDS_PER_STRIP, 3 * NUM_LEDS_PER_STRIP + 29)) ;

CRGBSet CJCap_A(leds(30, NUM_LEDS_PER_STRIP )) ;
CRGBSet CJCap_B(leds(NUM_LEDS_PER_STRIP + 30, NUM_LEDS_PER_STRIP )) ;
CRGBSet CJCap_C(leds(2 * NUM_LEDS_PER_STRIP + 30, 2 *  NUM_LEDS_PER_STRIP )) ;
CRGBSet CJCap_D(leds(3 * NUM_LEDS_PER_STRIP + 30, 3 * NUM_LEDS_PER_STRIP )) ;
...
void setup() {
  ...
  FastLED.addLeds<LED_TYPE,DATA_PIN_A,CLK_PIN,COLOR_ORDER, DATA_RATE_MHZ(2) >(leds, 0, NUM_LEDS_PER_STRIP).setCorrection(TypicalLEDStrip);
  FastLED.addLeds<LED_TYPE,DATA_PIN_B,CLK_PIN,COLOR_ORDER, DATA_RATE_MHZ(2) >(leds, NUM_LEDS_PER_STRIP, NUM_LEDS_PER_STRIP).setCorrection(TypicalLEDStrip);
  FastLED.addLeds<LED_TYPE,DATA_PIN_C,CLK_PIN,COLOR_ORDER, DATA_RATE_MHZ(2) >(leds, 2 * NUM_LEDS_PER_STRIP, NUM_LEDS_PER_STRIP).setCorrection(TypicalLEDStrip);
  FastLED.addLeds<LED_TYPE,DATA_PIN_D,CLK_PIN,COLOR_ORDER, DATA_RATE_MHZ(2) >(leds, 3 * NUM_LEDS_PER_STRIP, NUM_LEDS_PER_STRIP).setCorrection(TypicalLEDStrip);
...
void MakePalettes()
{
  Serial.println("making palettes") ;
